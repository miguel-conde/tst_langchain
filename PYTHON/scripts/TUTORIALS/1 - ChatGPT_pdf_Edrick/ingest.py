...
def parse_pdf(file_path: str) -> Tuple[List[Tuple[int, str]]:, Dict[str, str]]:
    ...
    :param file_ath: The path to the PDF file
    :return A tuple containing the title and a list of tuples with page numbers
    """
...
def extract_pages_from_pdf(file_path) -> List[Tuple[int, str]]:
    """
    Extracts the text from each page of the PDF

    :paran file_path: The path to the PDF file
